...
https://github.com/apenwarr/redo/blob/master/Documentation/md2man.py

It is distributed under the terms of GPLv2.
"""
...
def _text(bitlist):
    ...
    for typ, text in bitlist:
        if not typ:
            ...
            raise ValueError('unexpected tag %r inside %r' % (typ, text))
    out = out.strip()
